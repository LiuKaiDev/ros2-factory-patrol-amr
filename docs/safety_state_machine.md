...
| `LOCALIZATION_LOST` | current in task layer / planned safety integration | 建议输出零速度 | Yes | Depends on relocalization result |
...
stateDiagram-v2
  ...
  NORMAL --> LOCALIZATION_LOST: AMCL covariance high
